...
# %%
# Data
photometry_table_file = os.path.join(PHOT_DATA, "merged_synphot_normal_class.csv")
...
feature40_table_name = os.path.join(FEATURE_ORIGINAL_DATA, 'features_40.csv')
...
eng_table['uid'] = photometry_table['uid'].data
feature20_table_name = os.path.join(FEATURE_ORIGINAL_DATA, 'features_20.csv')
...
eng_table['uid'] = photometry_table['uid'].data
feature_rubin_7dt40_table_name = os.path.join(FEATURE_ORIGINAL_DATA, 'features_rubin_7dt40.csv')
...
eng_table['uid'] = photometry_table['uid'].data
feature_rubin_7dt20_table_name = os.path.join(FEATURE_ORIGINAL_DATA, 'features_rubin_7dt20.csv')
...
logtxt += "END\n"
logtxt_path = os.path.join(FEATURE_ORIGINAL_DATA, "log.txt")
