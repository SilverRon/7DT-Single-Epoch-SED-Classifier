...
# %%
# Data
photometry_table_file = os.path.join(PHOT_DATA, "merged_synphot_anormaly_class.csv")
...
feature40_table_name = os.path.join(FEATURE_ORIGINAL_DATA, 'features_40_kn.csv')
...
eng_table['uid'] = photometry_table['uid'].data
feature20_table_name = os.path.join(FEATURE_ORIGINAL_DATA, 'features_20_kn.csv')
...
eng_table['uid'] = photometry_table['uid'].data
feature_rubin_7dt40_table_name = os.path.join(FEATURE_ORIGINAL_DATA, 'features_rubin_7dt40_kn.csv')
...
eng_table['uid'] = photometry_table['uid'].data
feature_rubin_7dt20_table_name = os.path.join(FEATURE_ORIGINAL_DATA, 'features_rubin_7dt20_kn.csv')
...
import yaml
# 저장
feature_config_name = os.path.join(CONFIG, 'feature_kn.yaml')
...
logtxt += "END\n"
logtxt_path = os.path.join(FEATURE_ORIGINAL_DATA, "log_kn.txt")
