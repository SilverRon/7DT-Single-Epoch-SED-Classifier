...
# Data
logtxt = ""
photometry_table_file = os.path.join(PHOT_ENGRAVE_DATA, "merged_synphot_anormaly_class.csv")
...
logtxt += "\n"
### Save
feature40_table_name = os.path.join(FEATURE_ENGRAVE_DATA, 'features_40.csv')
...
feature40_color_only_table_name = os.path.join(FEATURE_ENGRAVE_DATA, 'features_40_color_only.csv')
...
feature40_rubin_7dt_color_only_table_name = os.path.join(FEATURE_ENGRAVE_DATA, 'features_40_rubin_7dt_color_only.csv')
...
feature40_rubin_color_only_table_name = os.path.join(FEATURE_ENGRAVE_DATA, 'features_40_rubin_color_only.csv')
...
logtxt += "\n"
eng20_table[:5]
feature20_table_name = os.path.join(FEATURE_ENGRAVE_DATA, 'features_20.csv')
...
logtxt += f"{len(eng20_table.keys())-2} keys generated\n"
feature20_color_only_table_name = os.path.join(FEATURE_ENGRAVE_DATA, 'features_20_color_only.csv')
...
feature20_rubin_7dt_color_only_table_name = os.path.join(FEATURE_ENGRAVE_DATA, 'features_20_rubin_7dt_color_only.csv')
...
feature20_rubin_color_only_table_name = os.path.join(FEATURE_ENGRAVE_DATA, 'features_20_rubin_color_only.csv')
...
with open(os.path.join(FEATURE_ENGRAVE_DATA, 'log.txt'), 'w') as f:
	f.write(logtxt)
print(logtxt)